...
import com.mdapp.countriesflags.NesterRecyclerView.StartSnapHelper

class OuterAdapter(private val mItemClickListener: InnerAdapter.OnItemClickListener?) :
    ...
    private inner class CellViewHolder(
        val rv: RecyclerView,
        listener: InnerAdapter.OnItemClickListener?
